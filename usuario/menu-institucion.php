...
<html lang="en">
    ...
    <body>   
        ...
        <section class="hero" id="hero">
            <div class="container">
                <h1 class="head">MENU PRINCIPAL DE LA ADMINISTRACIÓN</h1>
            </div>
        </section>
            ...
            <div class="container-form">
                <div class="cont-form">
                    ...
                    <form action="informacion.php">
                        <input class="boton" type="submit" value="Información Generacional">
                    </form>
                    <form action="infraestructura.php">
                        <input class="boton" type="submit" value="Infraestructura">
                    </form>
                </div>
            </div>
